  ...
  return (
    <div className="px-6 py-[120px] md:px-10">
      <div className="mx-auto max-w-[1200px]">
        ...
        <a
          href="/#waitlist"
          className="mt-8 inline-block font-mono text-[11px] font-bold tracking-[.18em] bg-[var(--accent)] text-[#0A0A0A] px-6 py-3.5 rounded-lg transition-[filter,transform] hover:brightness-[1.12] hover:-translate-y-0.5"
        >
          JOIN THE WAITLIST
        </a>
      </div>
