                    ...
                    <div className="relative">
                      ...
                      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
                        <a
                          ...
                          className="rounded-lg font-mono text-[10px] font-bold tracking-[.18em] bg-[var(--accent)] text-[#0A0A0A] px-5 py-2.5 transition-[filter,transform] hover:brightness-[1.12] hover:-translate-y-0.5"
                        >
                          SUBSCRIBE
                        </a>
                        <a
          ...
          <section className="py-[60px] md:py-[80px]">
            ...
            <div className="mt-8 flex flex-wrap gap-4">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="cta-pulse inline-block rounded-lg font-mono text-[11px] font-bold tracking-[.18em] bg-[var(--accent)] text-[#0A0A0A] px-6 py-3.5 transition-[filter,transform] hover:brightness-[1.12] hover:-translate-y-0.5"
              >
